...
// CrashCase005 : only for local test
func (cm *CaseManager) CrashCase005() (err error) {
	env, err := models.NewTestEnv("./cases/CrashCase005.ENV", cm.UseMatrix, cm.EthEndPoint)
	if err != nil {
		return
	}
	defer func() {
