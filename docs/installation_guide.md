...
## Installation
The preferred way to install Photon is downloading a self contained application bundle from the [GitHub release page](https://github.com/MetaLife-Protocol/SuperNode/releases)
### Linux
Download the latest photon-<version>-[linux.tar.gz](https://github.com/MetaLife-Protocol/SuperNode/releases), and extract it:
...
### macOS
Download the latest photon-<version>-[macOS.zip](https://github.com/MetaLife-Protocol/SuperNode/releases), and extract it:
```
...
### Preliminaries
In order to work with  [`Photon`](https://github.com/MetaLife-Protocol/SuperNode), the following build dependencies are required:  
